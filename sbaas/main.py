...
#io01.import_dataStage01RNASequencingAnalysis_add(settings.workspace_data+'/_input/150806_RNASequencing_ALEsKOs01_analysis01.csv');
## upload the visualization file
#visio01.import_visualizationProject_add(settings.workspace_data+'/_input/150806_Visualization_ALEsKOs01_project11.csv');
