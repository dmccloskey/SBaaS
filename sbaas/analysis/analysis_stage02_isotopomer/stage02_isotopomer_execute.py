...
class stage02_isotopomer_execute(base_analysis):
    ...
    def execute_makeNetFluxes(self, simulation_id_I,simulation_dateAndTimes_I=[],normalize_rxn_id_I=None,convert_netRxn2IndividualRxns_I=False,
        ...
        for simulation_dateAndTime in simulation_dateAndTimes:
            ...
            if normalize_rxn_id_I: 
                ...
                flux_average_norm,flux_stdev_norm,flux_lb_norm,flux_ub_norm,flux_units_norm = self.stage02_isotopomer_query.get_flux_simulationIDAndSimulationDateAndTimeAndRxnID_dataStage02IsotopomerfittedFluxes(simulation_id_I,simulation_dateAndTime,normalize_rxn_id_I);
            ...
            for k,v in rxns_pairs.items():
                ...
                # normalize the flux to normalize_rxn_id_I
                if normalize_rxn_id_I:
                    if flux_units_1!='':
                        flux_average_1,flux_stdev_1,flux_lb_1,flux_ub_1,flux_units_1=self.normalize_flux(normalize_rxn_id_I,flux_average_norm,flux_stdev_norm,flux_lb_norm,flux_ub_norm,flux_average_1,flux_stdev_1,flux_lb_1,flux_ub_1);
                    if flux_units_2!='':
                        flux_average_2,flux_stdev_2,flux_lb_2,flux_ub_2,flux_units_2=self.normalize_flux(normalize_rxn_id_I,flux_average_norm,flux_stdev_norm,flux_lb_norm,flux_ub_norm,flux_average_2,flux_stdev_2,flux_lb_2,flux_ub_2);
    ...
    def execute_findNetFluxSignificantDifferences(self,analysis_id_I, criteria_I = 'flux_lb/flux_ub',
        ...
        if simulation_ids_I and simulation_dateAndTimes_I:
            ...
            for simulation_id in simulation_ids_unique:
                ...
                simulation_dateAndTimes_tmp = self.stage02_isotopomer_query.get_simulationDateAndTimes_simulationID_dataStage02IsotopomerfittedNetFluxes(simulation_id);
    ...
    def check_observableFlux(self,flux_I,flux_lb_I,flux_ub_I):
        ...
        if flux_I is None:
            observable = False;
        elif flux_I==0.0 and flux_lb_I==0.0 and flux_ub_I==0.0:
            observable = False;
                ...
                for mapping_id in mapping_ids:
                    ...
                    if stationary_I:
                        ...
                        with open(filename_mat,'w') as f:
                            f.write(mat_script);
    def execute_removeUnboundedFittedFluxes(self,simulation_id_I,flux_lb_I=1e-6,flux_ub_I=999.9):
        '''Remove unbounded fluxes prior to calculating the net flux
        INPUT:
        simulation_id_I = simulation_id
        '''
        self.stage02_isotopomer_query.setUnbounded2False_simulationID_dataStage02IsotopomerFittedFluxes(simulation_id_I,flux_lb_I,flux_ub_I);
class inca_api():
