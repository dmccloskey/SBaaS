...
class stage01_rnasequencing_io(base_analysis):
    ...
    def import_dataStage01RNASequencingFpkmTracking_add(self,filename,experiment_id,sample_name):
        '''table adds'''
        ...
        self.add_dataStage01RNASequencingFpkmTracking(genesfpkmtracking.genesFpkmTracking);
    ...
    def import_dataStage01RNASequencingGeneExpDiff_add(self, filename,experiment_id_1,experiment_id_2,sample_name_abbreviation_1,sample_name_abbreviation_2):
        '''table adds'''
        genesfpkmtracking = genes_fpkm_tracking();
        genesfpkmtracking.import_genesFpkmTracking(filename_I=filename,experiment_id_1_I = experiment_id_1,experiment_id_2_I = experiment_id_2,
