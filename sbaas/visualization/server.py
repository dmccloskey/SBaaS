...
class IndexHandler(BaseHandler):
    ...
    def get(self):
        ...
        data = template.render(d3=url.get_url('d3', source),
                               ...
                               logo1=url.get_url('logo1', source),
                               logo2=url.get_url('logo2', source),
                               logo3=url.get_url('logo3', source),
                               logo4=url.get_url('logo4', source),
                               logo5=url.get_url('logo5', source),
                               logo6=url.get_url('logo6', source),
                               github=url.get_url('github'),
