...
# ORM classes
class data_stage02_isotopomer_analysis(Base):
    __tablename__ = 'data_stage02_isotopomer_analysis'
    id = Column(Integer, Sequence('data_stage02_isotopomer_analysis_id_seq'), primary_key=True)
