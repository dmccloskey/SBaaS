...
config.set("DATA_DIR", "workspace", "..\\..\\sbaas_workspace\\sbaas_workspace\\workspace")
config.set("DATA_DIR", "workspace_data", "..\\..\\sbaas_workspace\\sbaas_workspace\\workspace_data")
config.set("DATA_DIR", "visualization_data", "..\\..\\sbaas_workspace\\sbaas_workspace\\visualization_data")
config.set("DATA_DIR", "visualization_resources", "..\\..\\sbaas_workspace\\sbaas_workspace\\visualization_resources")
